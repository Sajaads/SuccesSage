...
import 'package:successage/chats/chat_services.dart';
import 'package:successage/chats/messages.dart';
import 'package:uuid/uuid.dart';

class ChatPage extends StatefulWidget {
  final Map<String, dynamic> mentee;
  const ChatPage({super.key,required this.mentee});
...
class _ChatPageState extends State<ChatPage> {
 late String id = widget.mentee['uid'];
  ...
  void _handleSendPressed(types.PartialText message) {
   ...
   _chatService.sendMessage(convertToMessageModel(textMessage)); // Store message in Firestore
  }
...
// Convert TextMessage to Message model
  ...
  Widget build(BuildContext context) => Scaffold(
    appBar: AppBar(
        title: Text('${widget.mentee['fname']}'),
